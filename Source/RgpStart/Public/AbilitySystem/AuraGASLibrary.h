 ...
 */
UCLASS()
class RGPSTART_API UAuraGASLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static void GetLiveActorWithinRadius(const UObject* WorldContextObject, const FVector& SphereOrigin, float Radius, TArray<AActor*>& OutActors, const TArray<AActor*>& IgnoreActors);
